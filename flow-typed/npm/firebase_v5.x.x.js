...
declare class $npm$firebase$auth$Auth {
  ...
  createUserWithEmailAndPassword(email: string, password: string): Promise<$npm$firebase$auth$UserCredential>;
...
declare class $npm$firebase$auth$PhoneAuthProvider extends $npm$firebase$auth$AuthProvider {
  ...
  static PROVIDER_ID: string;
  static credential(verificationId: string, verificationCode: string): $npm$firebase$auth$AuthCredential;
...
declare type $npm$firebase$database$Callback = ($npm$firebase$database$DataSnapshot, ?string) => void | Promise<void>;
